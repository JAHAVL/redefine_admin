...
// Import the Mail Settings Widget
...
const MailSettingsPage: React.FC = () => {
  ...
  return (
    <div className="task-manager-page">
      ...
      {/* Sub Menu Component */}
      <SubMenu activeItem="settings" mainSection="mail" />
      ...
      <div className="main-content-wrapper">
        ...
        <main className={`task-manager-content ${raiChatExpanded ? 'rai-expanded' : 'rai-collapsed'}`} style={{ padding: 0, overflow: 'hidden' }}>
          <div className="mail-settings-container" style={{ height: '100%', width: '100%', background: 'transparent', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            {/* Integrate the Mail Settings Widget */}
