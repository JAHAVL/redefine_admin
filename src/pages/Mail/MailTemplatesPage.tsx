...
// Import the Mail Templates Widget
...
const MailTemplatesPage: React.FC = () => {
  ...
  return (
    <div className="task-manager-page">
      ...
      {/* Sub Menu Component */}
      <SubMenu activeItem="templates" mainSection="mail" />
      ...
      <div className="main-content-wrapper">
        ...
        <main className={`task-manager-content ${raiChatExpanded ? 'rai-expanded' : 'rai-collapsed'}`} style={{ padding: 0, overflow: 'hidden' }}>
          <div className="mail-templates-container" style={{ height: '100%', width: '100%', background: 'transparent', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            {/* Integrate the Mail Templates Widget */}
