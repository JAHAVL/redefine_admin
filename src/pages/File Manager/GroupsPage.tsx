...
import GroupsWidget from '../../widgets/File Manager/GroupsWidget';
...
const GroupsPage: React.FC = () => {
  ...
  return (
    <div className="task-manager-page">
      ...
      {/* Sub Menu Component - Note that we set activeItem to "groups" but mainSection to "file-manager" to keep the same submenu */}
      <SubMenu activeItem="groups" mainSection="file-manager" />
