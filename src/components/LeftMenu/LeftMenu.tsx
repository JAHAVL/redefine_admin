...
const LeftMenu: React.FC<LeftMenuProps> = ({ activeItem = 'dashboard', onCollapse }) => {
  ...
  const menuItems = [
    ...
    { id: 'schedule', label: 'Schedules', icon: 'https://images.ctfassets.net/1itkm9rji8jb/262tDgGk3FOuhQ8nlVUoiY/d0232b2f29e5193aaedae4a4b6bfe08f/ico-sch.svg', link: '/scheduler' },
