...
interface SchedulerPageTemplateProps {
  children: React.ReactNode;
}

const SchedulerPageTemplate: React.FC<SchedulerPageTemplateProps> = ({ children }) => {
  ...
  return (
    <div className="task-manager-page">
      ...
      {/* Sub Menu Component */}
      <SubMenu activeItem="dashboard" mainSection="scheduler" />
...
export default SchedulerPageTemplate;
