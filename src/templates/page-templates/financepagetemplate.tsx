...
interface FinancePageTemplateProps {
  children: React.ReactNode;
}

const FinancePageTemplate: React.FC<FinancePageTemplateProps> = ({ children }) => {
  ...
  return (
    <div className="task-manager-page">
      ...
      {/* Sub Menu Component */}
      <SubMenu activeItem="dashboard" mainSection="finance" />
...
export default FinancePageTemplate;
