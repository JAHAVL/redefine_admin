...
import { mockSeries, mockSpecialSeries, mockPastSeries, mockPastSpecialSeries } from '../mockData';
...
const Tab = styled('button')<{ active: boolean }>`
  ...
  font-weight: ${props => props.active ? theme.typography.fontWeights.semibold : theme.typography.fontWeights.normal};
  cursor: pointer;
