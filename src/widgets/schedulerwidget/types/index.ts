...
export enum ActionTypes {
    ...
    FETCH_SPECIAL_SERIES_REQUEST = 'FETCH_SPECIAL_SERIES_REQUEST',
    FETCH_SPECIAL_SERIES_SUCCESS = 'FETCH_SPECIAL_SERIES_SUCCESS',
    FETCH_SPECIAL_SERIES_FAILURE = 'FETCH_SPECIAL_SERIES_FAILURE',
    
    FETCH_SERIES_DETAILS_REQUEST = 'FETCH_SERIES_DETAILS_REQUEST',
    FETCH_SERIES_DETAILS_SUCCESS = 'FETCH_SERIES_DETAILS_SUCCESS',
    FETCH_SERIES_DETAILS_FAILURE = 'FETCH_SERIES_DETAILS_FAILURE',
    
    FETCH_EVENT_DETAILS_REQUEST = 'FETCH_EVENT_DETAILS_REQUEST',
    FETCH_EVENT_DETAILS_SUCCESS = 'FETCH_EVENT_DETAILS_SUCCESS',
    FETCH_EVENT_DETAILS_FAILURE = 'FETCH_EVENT_DETAILS_FAILURE',
