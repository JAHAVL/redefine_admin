  ...
  return (
    <div style={{ 
      ...
      <div style={{ marginTop: '30px' }}>
        ...
        <ul>
          <li><strong>Page:</strong> {title}</li>
          <li><strong>Route:</strong> Current route path</li>
          <li><strong>Widgets:</strong> Would load appropriate widgets based on the route</li>
        </ul>
      </div>
    </div>
  );
