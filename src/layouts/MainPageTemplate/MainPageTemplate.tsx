...
import RAIChat from '../../components/RAIChat/RAIChat';
import { useRAIChat } from '../../components/RAIChat';
...
const MainPageTemplate: React.FC<MainPageTemplateProps> = ({ 
  ...
  const { expanded: raiChatExpanded, setExpanded: setRaiChatExpanded } = useRAIChat();
